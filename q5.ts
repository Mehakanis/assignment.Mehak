...
let famous_person:string = "Daren Hardy";
let message:string = ` ${famous_person} once said,"You will never change your life until you change the habits you do daily."`;
